package com.lrj.erp.procurement;
 ...
 * <p>作用有三：
 * <ol>
 *   <li>以代码形式声明本模块的 <b>Data Ownership</b>：拥有的表前缀为 pur_；</li>
 ...
 * <p>本接口不应被实现，也不承载任何行为。
 */
public interface ProcurementModule {

    /** Maven 模块名。 */
    String MODULE = "erp-procurement";

    /** 本模块拥有的数据库表前缀；跨模块访问由 TableOwnershipArchitectureTest 拦截。 */
    String TABLE_PREFIX = "pur_";
}
