...
public record CostSnapshot(BigDecimal quantity, BigDecimal inventoryValue, Long countDocumentId) {
    /** 成本查询的兼容构造器。 */
    public CostSnapshot(BigDecimal quantity, BigDecimal inventoryValue) { this(quantity, inventoryValue, null); }
