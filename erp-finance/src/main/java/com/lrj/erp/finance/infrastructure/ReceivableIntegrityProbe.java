...
@Component
public class ReceivableIntegrityProbe implements IntegrityProbe {
    private final ReceivableIntegrityMapper mapper;
    public ReceivableIntegrityProbe(ReceivableIntegrityMapper mapper) { this.mapper=mapper; }
    public String name() { return "ar"; }
